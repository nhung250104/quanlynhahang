...
public partial class Form_PhieuNhap : Form
{
    ...
    // Tạo phiếu nhập mới → mở Form_CTPhieuNhap
    private void btnTaoPN_Click(object sender, EventArgs e)
    {
        // Lấy NCC được chọn (bỏ qua dòng "-- Tất cả --")
        string maNCC = cboNCC.SelectedValue?.ToString();
    ...
    // Xem chi tiết phiếu nhập đang chọn
    ...
    // So sánh giá nguyên liệu — gọi SP_SSGIA_NGUYENLIEU
    private void btnSoSanhGia_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // Hiển thị kết quả trong form mới đơn giản
            var frmSS = new Form
            {
